  ...
  const tiers = [
    {
      ...
      features: ['Local overlay — unlimited scans','DS coverage % per page','Token violation detection','AI context file export (.cursorrules, CLAUDE.md)','Page scaffold generator'],
