...
function OpenSourceStrip() {
  return (
    <div style={{
      borderTop: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}`,
      padding: '20px 48px', background: C.surface,
      display: 'flex', alignItems: 'center', justifyContent: 'center',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <span style={{ ...sans, fontSize: 13, color: C.muted }}>Built in the open</span>
      </div>
      <div style={{ width: 1, height: 16, background: C.border }} />
      <span style={{ ...sans, fontSize: 13, color: C.muted }}>Contributors welcome — UX leads, design system engineers, PMs</span>
      <div style={{ width: 1, height: 16, background: C.border }} />
      <a
        href="https://github.com/dyoon92/design-drift"
        target="_blank" rel="noopener noreferrer"
        style={{
          ...sans, fontSize: 12, fontWeight: 700, color: C.text,
